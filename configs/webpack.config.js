...
const COMMON_PLUGINS = [
   ...
   */
  new HtmlWebpackPlugin({ hash: inProduction, template: 'static/index.html' }),
   ...
   */
  new Dotenv({ defaults: !inProduction }), // if not production, use .env.defaults
...
module.exports = () => {
  return {
    ...
    */
     ...
     */
    devServer: inProduction ? undefined : {
